-- Bronze layer schema for claude-otel-session-scorer.
-- Copied from IceRhymers/databricks-claude (docs/otel-uc-schemas.sql).
-- These tables are written by the OTLP proxy in databricks-claude and are
-- the expected input to the Silver ETL job in this repo.
